<template>
  <el-row>
    <el-col :span="24">
      <el-card shadow="hover" class="card-layout">
        ...
        <el-button type="primary" plain @click="previewPDF">
          浏览PDF
        </el-button>
      </el-card>
    </el-col>
  ...
  <el-row>
    <vue-office-docx
      v-if="showDOCX"
      src="https://yjy-teach-oss.oss-cn-beijing.aliyuncs.com/solution/demo.docx"
      style="width: 100vw; height: 100vh"
    />
    <vue-office-xlsx
      v-if="showXLSX"
      src="https://yjy-teach-oss.oss-cn-beijing.aliyuncs.com/solution/demo.xlsx"
      style="width: 100vw; height: 100vh"
    />
    <vue-office-pdf
      v-if="showPDF"
      src="https://yjy-teach-oss.oss-cn-beijing.aliyuncs.com/solution/demo.pdf"
      style="width: 100vw; height: 100vh"
    />
  </el-row>
</template>
